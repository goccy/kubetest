...
func (in *TestAgentSpec) DeepCopyInto(out *TestAgentSpec) {
	*out = *in
	if in.AllocationStartPort != nil {
		in, out := &in.AllocationStartPort, &out.AllocationStartPort
		*out = new(uint16)
		**out = **in
	}
...
func (in *TestJobPodSpec) DeepCopyInto(out *TestJobPodSpec) {
	*out = *in
	...
	if in.InitContainers != nil {
		...
		*out = make([]TestJobContainer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
